...
public class SecurityConfig {
    ...
    @Bean
    public WebSecurityCustomizer audioWebSecurityCustomizer() {
        return web -> web.ignoring().requestMatchers("/audio", "/audio/**");
    }

    @Bean
    @Order(0)
    public SecurityFilterChain publicAudioSecurityFilterChain(HttpSecurity http) throws Exception {
        http
                .securityMatcher("/audio", "/audio/**")
