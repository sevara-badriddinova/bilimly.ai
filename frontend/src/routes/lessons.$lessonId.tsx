...
import { getLesson, getLessonCategory, getLessonLevel, getLessonText, getNextLesson, getPrevLesson } from "@/data/lessons";
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <div className="mb-10 flex items-start gap-5">
          ...
          <div>
            ...
            {language?.slice(0, 2) !== "en" && <p className="mt-1 text-lg italic text-muted-foreground">{lesson.title}</p>}
