    ...
    return (
        <div className="space-y-8">
            ...
            <Group icon={Lock} title={t("settings.security")}>
                <Row label={t("settings.twoFactor")} value={t("settings.twoFactorOff")}
                     action={t("settings.twoFactorEnable")}/>
                <Row label={t("settings.devices")} value={t("settings.devicesValue", {n: 2})}
