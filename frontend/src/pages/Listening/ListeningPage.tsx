...
const TRACK_TEXT: Record<number, Record<"en" | "uz" | "ru", { title: string; question: string; options: string[]; explanation: string }>> = {
  1: {
    en: { title: "Coffee Shop Conversation", question: "What did the customer order?", options: ["A cappuccino and a croissant", "Tea and a sandwich", "Only a croissant", "Coffee for here"], explanation: "The customer asks for a large cappuccino to go and one croissant." },
    uz: { title: "Kafedagi suhbat", question: "Mijoz nima buyurtma qildi?", options: ["Kapuchino va kruassan", "Choy va sendvich", "Faqat kruassan", "Shu yerda ichiladigan qahva"], explanation: "Mijoz olib ketish uchun katta kapuchino va bitta kruassan so'raydi." },
    ru: { title: "Разговор в кофейне", question: "Что заказал клиент?", options: ["Капучино и круассан", "Чай и сэндвич", "Только круассан", "Кофе на месте"], explanation: "Клиент просит большой капучино с собой и один круассан." },
  },
  2: {
    en: { title: "Tech Interview Tips", question: "What is the main advice in the interview conversation?", options: ["Explain your projects clearly", "Memorize every answer", "Avoid asking questions", "Speak as fast as possible"], explanation: "The conversation focuses on explaining your work with clear examples." },
    uz: { title: "IT intervyu maslahatlar", question: "Intervyu suhbatidagi asosiy maslahat nima?", options: ["Loyihalaringizni aniq tushuntiring", "Har bir javobni yodlang", "Savol bermang", "Iloji boricha tez gapiring"], explanation: "Suhbat ishlaringizni aniq misollar bilan tushuntirishga qaratilgan." },
    ru: { title: "Советы для IT-интервью", question: "Какой главный совет в разговоре про интервью?", options: ["Чётко объясняйте свои проекты", "Выучите все ответы", "Не задавайте вопросы", "Говорите как можно быстрее"], explanation: "Разговор о том, как объяснять свою работу на понятных примерах." },
  },
  3: {
    en: { title: "Travel in London", question: "What kind of conversation is practiced?", options: ["Travel and directions", "Ordering dinner", "A job interview", "A school exam"], explanation: "This track practices travel phrases and asking for help while moving around London." },
    uz: { title: "Londonga sayohat", question: "Qanday suhbat mashq qilinadi?", options: ["Sayohat va yo'nalish so'rash", "Kechki ovqat buyurtma qilish", "Ish intervyusi", "Maktab imtihoni"], explanation: "Bu trek sayohat iboralari va Londonda yordam so'rashni mashq qiladi." },
    ru: { title: "Путешествие в Лондоне", question: "Какой тип разговора тренируется?", options: ["Путешествие и маршруты", "Заказ ужина", "Собеседование", "Школьный экзамен"], explanation: "Трек тренирует фразы для путешествий и просьбы о помощи в Лондоне." },
  },
  4: {
    en: { title: "AI and the Future", question: "What is the topic of the conversation?", options: ["Artificial intelligence and future work", "Cooking at home", "Airport security", "Buying clothes"], explanation: "The track is about AI and how it may change future work." },
    uz: { title: "AI va kelajak", question: "Suhbat mavzusi nima?", options: ["Sun'iy intellekt va kelajakdagi ish", "Uyda ovqat pishirish", "Aeroport xavfsizligi", "Kiyim sotib olish"], explanation: "Trek AI va uning kelajakdagi ishni qanday o'zgartirishi haqida." },
    ru: { title: "ИИ и будущее", question: "Какая тема разговора?", options: ["Искусственный интеллект и работа будущего", "Готовка дома", "Безопасность в аэропорту", "Покупка одежды"], explanation: "Трек о том, как ИИ может изменить работу в будущем." },
  },
  5: {
    en: { title: "Daily Routines Podcast", question: "Which language area does this podcast practice?", options: ["Daily routines", "Advanced finance", "Academic writing", "Weather reports"], explanation: "The track practices common phrases for everyday routines." },
    uz: { title: "Kundalik tartiblar", question: "Bu podkast qaysi til mavzusini mashq qiladi?", options: ["Kundalik tartiblar", "Murakkab moliya", "Akademik yozuv", "Ob-havo xabarlari"], explanation: "Trek kundalik tartiblar uchun keng ishlatiladigan iboralarni mashq qiladi." },
    ru: { title: "Подкаст о распорядке дня", question: "Какую языковую тему тренирует этот подкаст?", options: ["Повседневный распорядок", "Сложные финансы", "Академическое письмо", "Прогноз погоды"], explanation: "Трек тренирует частые фразы для повседневного распорядка." },
  },
  6: {
    en: { title: "Business English Pro", question: "What is the focus of this listening track?", options: ["Professional business English", "Basic alphabet sounds", "Restaurant menus", "Vacation photos"], explanation: "This track focuses on formal business vocabulary and professional situations." },
    uz: { title: "Biznes ingliz", question: "Bu tinglash trekining asosiy mavzusi nima?", options: ["Professional biznes ingliz tili", "Alifbo tovushlari", "Restoran menyulari", "Ta'til rasmlari"], explanation: "Bu trek rasmiy biznes lug'ati va professional vaziyatlarga qaratilgan." },
    ru: { title: "Деловой английский Pro", question: "На чём сфокусирован этот трек?", options: ["Профессиональный деловой английский", "Звуки алфавита", "Меню ресторанов", "Фото из отпуска"], explanation: "Трек посвящён официальной деловой лексике и профессиональным ситуациям." },
  },
};

const LISTENING_UI = {
  en: { check: "Comprehension check", ready: "Ready", listenFirst: "Listen first", correct: "Correct. ", wrong: "Not quite. " },
  uz: { check: "Tushunishni tekshirish", ready: "Tayyor", listenFirst: "Avval tinglang", correct: "To'g'ri. ", wrong: "Noto'g'ri. " },
  ru: { check: "Проверка понимания", ready: "Готово", listenFirst: "Сначала прослушайте", correct: "Верно. ", wrong: "Не совсем. " },
};

const TRANSCRIPT = [
  { time: "0:00", en: "Hi, can I get a large cappuccino, please?", uz: "Salom, kattaroq kapuchino bera olasizmi?", ru: "Здравствуйте, можно мне большой капучино, пожалуйста?" },
  { time: "0:05", en: "Of course. Would you like it for here or to go?", uz: "Albatta. Bu yerdami yoki olib ketish uchunmi?", ru: "Конечно. Здесь или с собой?" },
  { time: "0:09", en: "To go, please. And one croissant.", uz: "Olib ketish uchun, iltimos. Va bitta kruassan.", ru: "С собой, пожалуйста. И один круассан." },
  { time: "0:13", en: "That'll be six pounds fifty.", uz: "Olti funt ellik bo'ladi.", ru: "С вас шесть фунтов пятьдесят." },
];
...
export default function Listening() {
  ...
  const playAudio = (track = current) => {
    ...
    timerRef.current = setInterval(() => {
      setElapsed((value) => {
        const next = Math.min(track.seconds, value + 1);
      ...
      <Card variant="raised" className="md:p-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="mt-auto pt-5">
              <div className="flex items-center gap-3">
                ...
                <span className="font-mono text-sm text-muted-foreground">{formatTime(elapsed)} / {current.duration}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            {TRANSCRIPT.map((tr, i) => (
              ...
              >
                ...
                {lang !== "en" && <p className="ml-10 mt-1 text-sm italic text-muted-foreground">{tr[lang]}</p>}
              </motion.div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-6 rounded-2xl border-2 border-foreground/10 bg-background p-5">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
            ...
            <Pill tone={hasPlayed || elapsed > 0 ? "primary" : "muted"}>{hasPlayed ? LISTENING_UI[lang].ready : LISTENING_UI[lang].listenFirst}</Pill>
          </div>
        ...
        {filtered.map((tr, i) => {
          ...
          return (
            <motion.div
              ...
              whileHover={{ y: -3 }}
            >
              <Card onClick={() => chooseTrack(tr)} className={`flex items-center gap-4 hover:border-primary cursor-pointer ${current.id === tr.id ? "border-primary" : ""}`}>
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {lang !== "en" && <p className="truncate text-sm italic text-muted-foreground">{tr.title}</p>}
                </div>
                {completed ? (
                  <CheckCircle2 className="h-6 w-6 text-secondary" />
                ) : (
                  <button type="button" onClick={(event) => { event.stopPropagation(); playAudio(tr); }} className="grid h-10 w-10 place-items-center rounded-full bg-primary text-primary-foreground transition hover:scale-105">
