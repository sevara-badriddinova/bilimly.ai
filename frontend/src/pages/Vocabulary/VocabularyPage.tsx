...
const DECKS: Record<CategoryId, VocabCard[]> = {
  daily: [
    { word: "Routine", phon: "/ruːˈtiːn/", uz: "Kundalik tartib", example: "My morning routine starts at seven.", exampleUz: "Mening ertalabki tartibim soat yettida boshlanadi." },
    { word: "Errand", phon: "/ˈerənd/", uz: "Mayda yumush", example: "I need to run an errand after work.", exampleUz: "Ishdan keyin bitta yumushni bajarishim kerak." },
    { word: "Neighbor", phon: "/ˈneɪbər/", uz: "Qoʻshni", example: "Our neighbor is very friendly.", exampleUz: "Qoʻshnimiz juda samimiy." },
    { word: "Tidy", phon: "/ˈtaɪdi/", uz: "Saranjom", example: "Keep your desk tidy.", exampleUz: "Stolingizni saranjom tuting." },
  ],
  tech: [
    { word: "Deploy", phon: "/dɪˈplɔɪ/", uz: "Ishga tushirmoq", example: "We deploy the app every Friday.", exampleUz: "Biz ilovani har juma ishga tushiramiz." },
    { word: "Bug", phon: "/bʌɡ/", uz: "Xato", example: "The developer fixed the login bug.", exampleUz: "Dasturchi kirish xatosini tuzatdi." },
    { word: "Feature", phon: "/ˈfiːtʃər/", uz: "Funksiya", example: "This feature helps users practice speaking.", exampleUz: "Bu funksiya foydalanuvchilarga gapirishni mashq qilishga yordam beradi." },
    { word: "Backup", phon: "/ˈbækʌp/", uz: "Zaxira nusxa", example: "Save a backup before updating.", exampleUz: "Yangilashdan oldin zaxira nusxa saqlang." },
  ],
  travel: [
    { word: "Departure", phon: "/dɪˈpɑːrtʃər/", uz: "Joʻnab ketish", example: "The departure gate changed.", exampleUz: "Joʻnab ketish darvozasi oʻzgardi." },
    { word: "Luggage", phon: "/ˈlʌɡɪdʒ/", uz: "Yuk", example: "My luggage is too heavy.", exampleUz: "Yukim juda ogʻir." },
    { word: "Reservation", phon: "/ˌrezərˈveɪʃən/", uz: "Band qilish", example: "I have a hotel reservation.", exampleUz: "Mehmonxonadan joy band qilganman." },
    { word: "Directions", phon: "/dəˈrekʃənz/", uz: "Yoʻnalish", example: "Could you give me directions?", exampleUz: "Menga yoʻnalishni aytib bera olasizmi?" },
  ],
  food: [
    { word: "Ingredient", phon: "/ɪnˈɡriːdiənt/", uz: "Masalliq", example: "Tomatoes are the main ingredient.", exampleUz: "Pomidor asosiy masalliq." },
    { word: "Receipt", phon: "/rɪˈsiːt/", uz: "Chek", example: "Can I have the receipt, please?", exampleUz: "Chekni bera olasizmi?" },
    { word: "Spicy", phon: "/ˈspaɪsi/", uz: "Achchiq", example: "This soup is too spicy.", exampleUz: "Bu shoʻrva juda achchiq." },
    { word: "Dessert", phon: "/dɪˈzɜːrt/", uz: "Shirinlik", example: "We ordered dessert after dinner.", exampleUz: "Kechki ovqatdan keyin shirinlik buyurtma qildik." },
  ],
  business: [
    { word: "Deadline", phon: "/ˈdedlaɪn/", uz: "Muddat", example: "The deadline is tomorrow morning.", exampleUz: "Muddat ertaga ertalab." },
    { word: "Client", phon: "/ˈklaɪənt/", uz: "Mijoz", example: "The client approved the design.", exampleUz: "Mijoz dizaynni tasdiqladi." },
    { word: "Budget", phon: "/ˈbʌdʒɪt/", uz: "Byudjet", example: "We need to discuss the budget.", exampleUz: "Byudjetni muhokama qilishimiz kerak." },
    { word: "Invoice", phon: "/ˈɪnvɔɪs/", uz: "Hisob-faktura", example: "Please send the invoice today.", exampleUz: "Iltimos, hisob-fakturani bugun yuboring." },
  ],
  academic: [
    { word: "Research", phon: "/rɪˈsɜːrtʃ/", uz: "Tadqiqot", example: "Her research focuses on language learning.", exampleUz: "Uning tadqiqoti til oʻrganishga qaratilgan." },
    { word: "Essay", phon: "/ˈeseɪ/", uz: "Insho", example: "The essay needs a clear conclusion.", exampleUz: "Inshoga aniq xulosa kerak." },
    { word: "Evidence", phon: "/ˈevɪdəns/", uz: "Dalil", example: "Use evidence to support your idea.", exampleUz: "Fikringizni qoʻllab-quvvatlash uchun dalil ishlating." },
    { word: "Lecture", phon: "/ˈlektʃər/", uz: "Maʼruza", example: "The lecture starts at ten.", exampleUz: "Maʼruza soat oʻnda boshlanadi." },
  ],
};
    ...
    <div className="space-y-10">
      ...
      <Card variant="raised" className="relative overflow-hidden">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <PrimaryButton onClick={startDaily}><Sparkles className="h-4 w-4" /> {t("vocabulary.start")}</PrimaryButton>
        </div>
      </Card>
        ...
        <div className="mx-auto max-w-xl">
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
            ...
            <GhostButton onClick={toggleSave}>
              {saved.has(card.word) ? <BookmarkCheck className="h-4 w-4 fill-primary text-primary" /> : <Bookmark className="h-4 w-4" />}
              {saved.has(card.word) ? t("vocabulary.saved") : t("vocabulary.save")}
            </GhostButton>
            <PrimaryButton onClick={next}>{t("vocabulary.next")} <ArrowRight className="h-4 w-4" /></PrimaryButton>
          </div>
        </div>
      </div>
            ...
            {CATEGORIES.map((c, i) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                >
                  <button type="button" onClick={() => selectCategory(c.id)} className="block w-full text-left">
                    <Card className={`hover:border-primary cursor-pointer ${activeCategory === c.id ? "border-primary" : ""}`}>
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {Array.from(saved).map((w) => (
              <Card key={w} className="flex items-center justify-between py-3">
                ...
                <Pill tone="primary"><BookmarkCheck className="h-3 w-3" /> {t("vocabulary.savedTag")}</Pill>
              </Card>
            ))}
          </div>
        )}
