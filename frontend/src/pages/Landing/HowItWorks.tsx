  ...
  return (
    <section id="how-it-works" className="relative overflow-hidden bg-[#F8F0DC] py-20 sm:py-24">
      <div
        ...
        style={{ backgroundImage: `url(${suzaniPattern})`, backgroundRepeat: "repeat-x", backgroundSize: "auto 100%" }}
      />
      <img src={anorMotif} alt="" className="pointer-events-none absolute -right-12 top-24 h-44 w-44 rotate-12 object-contain opacity-20" />
      <img src={anorMotif} alt="" className="pointer-events-none absolute -left-14 bottom-20 h-40 w-40 -rotate-12 object-contain opacity-15" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div>
            <span className="inline-flex rounded-full border border-[#8F2F24]/15 bg-white/75 px-4 py-2 text-xs font-black uppercase tracking-[0.18em] text-[#8F2F24] shadow-sm">
          ...
          <p className="max-w-2xl text-base leading-8 text-[#4A3D68] lg:justify-self-end">
            Bilimly blends your current navy AI-learning design with a warmer Uzbek-inspired system: structured lessons, familiar explanation language, visible progress, and a coach that keeps learners moving.
          </p>
        </motion.div>
        ...
        <div id="learning-path" className="mt-14 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          ...
          >
            ...
            <div className="relative rounded-3xl border border-white/10 bg-white/[0.05] p-5">
              <div className="flex items-center justify-between gap-4 border-b border-white/10 pb-5">
                <div>
                  <p className="text-xs font-black uppercase tracking-[0.18em] text-[#F7C948]/80">Today plan</p>
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                {lessonPills.map((pill) => (
                  <span key={pill} className="rounded-full border border-white/10 bg-white/10 px-3 py-2 text-xs font-bold text-white/78">
                    {pill}
                  </span>
                ))}
              </div>
            ...
            <div className="relative mt-4 rounded-3xl border border-white/10 bg-white/[0.06] p-5">
              <div className="flex items-start gap-3">
                <img src={owlSuzani} alt="" className="mt-1 h-12 w-12 rounded-2xl bg-white/10 object-contain p-1" />
                <div>
                  <p className="text-sm font-black text-white">AI coach note</p>
                  <p className="mt-2 text-sm leading-6 text-white/64">
                    Try answering: “Tell me about a project you built.” I’ll correct grammar, make it sound natural, and explain the changes.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-4">
            {steps.map((step, index) => (
              ...
              >
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#F0F6FF] text-xl font-black text-[#0EA5C9] transition group-hover:bg-[#C44536] group-hover:text-white">
                  {step.number}
                </div>
                <div>
                ...
                <div className="w-fit rounded-2xl border border-[#F7C948]/50 bg-[#F7C948]/20 px-4 py-3 text-center text-sm font-black text-[#7A4E00] sm:w-20">
                  {step.metric}
                </div>
              </motion.article>
            ))}
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-[#4A3D68]">Start with a short lesson, then let the AI coach help with the hard parts.</p>
            </div>
          </div>
          <Link
            to="/auth/sign-up"
