    ...
    return (
        <div className="space-y-8">
            ...
            <Card variant="raised" className="md:p-8">
                <div className="grid gap-6 md:grid-cols-[auto_1fr_auto] md:items-center">
                    <div className="relative">
                        <div
                            className="grid h-24 w-24 place-items-center rounded-full bg-gradient-to-br from-primary/20 to-secondary/20 text-display text-4xl text-primary">
                            {initials}
                        </div>
                        <img src={humoBird} alt="" width={50} height={50}
                    ...
                    <div>
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                            ...
                            <Pill tone="accent"><Flame
                                className="h-3 w-3"/> {t("profile.streakChip", {n: progress.streakDays})}</Pill>
                ...
                <div className="mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4">
                    {[
                        ...
                        <div key={s.l}
                             className="rounded-2xl border-2 border-foreground/10 bg-background p-4 text-center">
            ...
            <Card>
                ...
                <p className="mt-1 text-sm text-muted-foreground">{t("profile.achievementsCount", {
                    earned,
                ...
                <div className="mt-5 grid grid-cols-3 gap-3 sm:grid-cols-4 lg:grid-cols-8">
                    {ACHIEVEMENTS.map((a, i) => (
                        ...
                        >
                            ...
                            <span
                                className="line-clamp-2 text-[10px] font-semibold leading-tight">{a.params ? t(a.key, a.params) : t(a.key)}</span>
                        </motion.div>
                    ))}
                </div>
            </Card>
