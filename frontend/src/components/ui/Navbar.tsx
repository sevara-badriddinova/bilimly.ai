  ...
  return (
    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:h-20 lg:px-8">
        ...
        >
          <div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl border border-white/10 bg-white/10 shadow-[0_12px_36px_rgba(14,165,201,0.18)]">
          ...
          <div className="leading-none">
            ...
            <span className="mt-1 hidden text-[11px] font-semibold uppercase tracking-[0.18em] text-sky-200/60 sm:block">
              AI English coach
            </span>
          </div>
        </Link>
        ...
        <div className="hidden items-center gap-8 lg:flex">
          {navItems.map((item) => (
            <a key={item.label} href={item.href} className="text-sm font-semibold text-white/72 transition hover:text-white">
              {item.label}
            </a>
          ))}
        </div>
        ...
        <div className="hidden items-center gap-3 sm:flex">
          ...
          {isAuthenticated ? (
            ...
            <>
              ...
              <Button asChild className="h-10 rounded-full bg-[#0EA5C9] px-5 text-sm font-black text-white shadow-[0_12px_30px_rgba(14,165,201,0.28)] hover:bg-[#0284C7]">
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-2 pt-3">
            ...
            {isAuthenticated ? (
              ...
              <div className="mt-2 grid grid-cols-2 gap-2">
                ...
                <NavLink to="/auth/sign-up" onClick={() => setMenuOpen(false)} className="rounded-full bg-[#0EA5C9] px-4 py-3 text-center text-sm font-black text-white">
