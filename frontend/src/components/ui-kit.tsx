...
export function Progress({value, label}: { value: number; label?: string }) {
    return (
        <div>
            {label && (
                <div
                    className="mb-1.5 flex items-center justify-between text-xs uppercase tracking-widest text-muted-foreground">
                    <span>{label}</span>
...
export function EmptyState({
    ...
    return (
        <div
            className="grid place-items-center rounded-2xl border-2 border-dashed border-foreground/15 bg-card/50 p-10 text-center">
